      ...
      <nav className="mt-2">
       ...
       with font-awesome or any other icon font library */}
          ...
          <li className="nav-item">
            ...
            <ul className="nav nav-treeview">
              <li className="nav-item">
              <input type="text" className="form-control" placeholder="Category Name" name="emailid" />
              ...
              <li className="nav-item">
              <input type="text" className="form-control" placeholder="Category Type" name="emailid" />
              ...
              <li className="nav-item">
              <button type="submit" className="btn btn-primary btn-block" value="register" >Submit</button>
          ...
          <li className="nav-item">
            ...
            <ul className="nav nav-treeview">
              <li className="nav-item">
              <input type="text" className="form-control" placeholder="Sub-Category Name" name="emailid" />
              ...
              <li className="nav-item">
              <input type="text" className="form-control" placeholder="Sub-Category Type" name="emailid" />
